...
export default function HomePage() {
  return (
    <div className="min-h-[calc(100vh-4rem)] bg-gray-900 text-white px-6 pt-6">
      {/* Top row: Left = Title + Image + Caption + Description, Right = Login */}
      <div className="mx-auto w-full max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-4 items-start">
        ...
        <div className="space-y-3">
          ...
          {/* Image (heading ke neeche, left aligned; width ko as-is chhod rahe hain) */}
          <div className="mt-2 flex justify-start">
            <img
              src="/family-tree.png"
              alt="Family Tree"
              className="h-[60vh] w-auto max-w-full object-contain rounded-lg shadow-lg"
            />
          </div>

          {/* Caption (description se bada aur colored) */}
