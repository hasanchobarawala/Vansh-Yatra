...
export default function HomePage() {
  return (
    <div className="min-h-[calc(100vh-4rem)] bg-gray-900 text-white px-6 pt-8">
      ...
      {/* Center image (big, centered) */}
      <div className="mx-auto mt-8 flex w-full max-w-6xl justify-center">
        <img
          src="/family-tree.png"
          alt="Family Tree"
          className="max-h-[56vh] w-auto object-contain rounded-lg shadow-xl"
        />
      </div>
    </div>
  );
